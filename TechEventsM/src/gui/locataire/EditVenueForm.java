 ...
 * @author Brahim
 */
public class EditVenueForm {

    TextModeLayout tl = new TextModeLayout(3, 2);
    Form mainForm = new Form(tl);

    public EditVenueForm(Local l) {
    ...
    mainForm.getToolbar().addCommandToRightBar("Back", getTheme().getImage("back-command.png"), new ActionListener() {
        ...
        TextComponent name = new TextComponent().label("Nom").text(l.getNom());
        TextComponent address = new TextComponent().label("Address").text(l.getAdresse()).multiline(true);
        TextComponent price = new TextComponent().text(String.valueOf(l.getPrix())).label("Price");
        TextComponent surface = new TextComponent().text(String.valueOf(l.getSurface())).label("Surface");
        TextComponent capacity = new TextComponent().text(String.valueOf(l.getCapacite())).label("Capacity");
        TextComponent x = new TextComponent().text(String.valueOf(l.getX())).label("Xcoord");
        TextComponent y = new TextComponent().text(String.valueOf(l.getY())).label("Ycoord");
