...
class EventsController extends Controller
{
    ...
    public function searchAction(Request $request)
    {
        ...
        {
         $entities =  $em->getRepository('EventBundle:Events')->findAll();
    ...
    public function newbackAction(Request $request)
    {
        ...
        return $this->render('events/newback.html.twig', array(
            'event' => $event,
            'form' => $form->createView(),
        ));
    }
     ...
     *
     */
    public function showbackAction(Events $event)
    {
        $deleteForm = $this->createDeleteForm($event);

        return $this->render('events/showback.html.twig', array(
            'event' => $event,
            'delete_form' => $deleteForm->createView(),
        ));
    }
     ...
     *
     */
    public function editbackAction(Request $request, Events $event)
    {
        $deleteForm = $this->createDeleteForm($event);
        $editForm = $this->createForm('MainBundle\Form\EventsType', $event);
        $editForm->handleRequest($request);
        ...
        return $this->render('events/editback.html.twig', array(
            'event' => $event,
            'edit_form' => $editForm->createView(),
            'delete_form' => $deleteForm->createView(),
        ));
     ...
     *
     */
    public function deletebackAction(Request $request, Events $event)
    {
        $form = $this->createDeleteForm($event);
        $form->handleRequest($request);
     ...
     * @return \Symfony\Component\Form\Form The form
     */
    private function createbackDeleteForm(Events $event)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('events_delete', array('idEvent' => $event->getIdEvent())))
            ->setMethod('DELETE')
    ...
    public function possearchAction()
    {
